...
// I originally copied this file from https://raw.githubusercontent.com/facebook/react-native/v0.80.0/packages/react-native/ReactAndroid/cmake-utils/default-app-setup/OnLoad.cpp
...
std::shared_ptr<TurboModule> cxxModuleProvider(
  ...
  if (name == NativeMultiplierModule::kModuleName) {
    return std::make_shared<NativeMultiplierModule>(jsInvoker);
  }
